##Este script fue solo para hacer una nueva barrida por toda la database
#recogiendo fechas, countries y todo con las nuevas funciones.
#Basicamente un database update para cuando redefinimos los modelos etc.
